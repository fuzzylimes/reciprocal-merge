...
export default function PrivacyBanner() {
  ...
  return (
    <>
        ...
        <Box display="flex" alignItems="center" justifyContent="space-between">
          <Box display="flex" alignItems="center">
            ...
            <Typography variant="body1" fontWeight="medium">
              Your files never leave your device - only DEA searches connect to external services
            </Typography>
          </Box>
          ...
          <Box sx={{ mt: 2 }}>
            <List dense disablePadding>
              ...
              <ListItem disableGutters>
                ...
                <ListItemText
                  primary="Browser-based processing"
                  secondary="Files are processed directly in your browser with no uploads"
                />
              </ListItem>
      ...
      >
        <DialogTitle>
          Privacy & Browser Processing Information
        </DialogTitle>
        <DialogContent>
          ...
          <List>
            ...
            <ListItem>
              ...
              <ListItemText
                primary="Browser-Based Processing"
                secondary="We use the File System Access API and standard browser capabilities to process files directly in your browser."
              />
            </ListItem>
